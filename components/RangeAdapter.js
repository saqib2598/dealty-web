...
const RangeAdapter = ({ input: { value, onChange, ...inputRest }, meta, hideLabel, id, label, ...rest }) => {
    ...
    <div>
      ...
      <style jsx global>{`
        ...
        .rc-slider-handle {
          ...
          cursor: grab;
          border-radius: 50%;
          border: solid 2px $teal-button;
          background-color: $teal-button;
          -ms-touch-action: pan-x;
              touch-action: pan-x;
        }
        .rc-slider-handle:focus {
          box-shadow: 0 0 0 5px $teal-button;
          outline: none;
        }
        ...
        .rc-slider-handle:active {
          box-shadow: 0 0 5px $teal-button;
